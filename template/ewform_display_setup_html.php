        ...
        <div class="ewf-main-column">
            ...
            <form action="#" method="post">
                <div class="input-group">
                    ...
                    <input value="<?php echo esc_attr(ewform_get_ewform_api_key_display($api_key)); ?>" <?php echo !empty($api_key) ? esc_attr("readonly")  : ''; ?>
                ...
                <div class="footer_btn">
                    <div class="activated_status">
                        <button disabled class="activated_text <?php echo esc_attr($activeClass); ?>">
                            <?php  printf(esc_html__("%s","easywebsiteform"), esc_html($activated) ); ?>
                        </button>
                    </div>
                    <?php
                    if (!empty($api_key)) {
